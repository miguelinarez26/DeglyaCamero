...
const Footer = () => {
    return (
        <footer className="bg-[#2a2622] text-gray-300 py-16 px-6 lg:px-12 border-t border-gray-700">
            <div className="max-w-7xl mx-auto grid md:grid-cols-4 gap-12">
                ...
                <div>
                    ...
                    <ul className="space-y-3 text-sm">
                        ...
                        <li><a href="#book" className="hover:text-primary transition-colors">El Libro</a></li>
                        <li><a href="#resources" className="hover:text-primary transition-colors">Recursos Gratuitos</a></li>
                    </ul>
                </div>
                ...
                <div>
                    ...
                    <ul className="space-y-3 text-sm">
                        <li><a href="#" className="hover:text-primary transition-colors">Coaching Personal</a></li>
                        <li><a href="#" className="hover:text-primary transition-colors">Terapia Psicológica</a></li>
                        <li><a href="#" className="hover:text-primary transition-colors">Consultoría Corporativa</a></li>
                        <li><a href="#" className="hover:text-primary transition-colors">Talleres y Cursos</a></li>
                    </ul>
                </div>

                <div>
                    <h5 className="text-white font-bold uppercase tracking-wider text-xs mb-6">Newsletter</h5>
                    <p className="text-sm opacity-80 mb-4">Recibe inspiración semanal en tu correo.</p>
                    <form className="flex flex-col gap-2">
                        <input type="email" placeholder="Tu correo electrónico" className="bg-white/10 border border-gray-600 rounded px-4 py-2 text-sm text-white placeholder-gray-400 focus:outline-none focus:border-primary" />
                        <button className="bg-secondary hover:bg-opacity-90 text-white text-sm font-bold py-2 rounded transition-colors">Suscribirse</button>
                    </form>
                </div>
            </div>
